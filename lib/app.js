...
/******/ 	__webpack_require__.p = "/Users/liuzhe/dev/surveyer/example";
/******/
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ComponentsPsdCanvas = __webpack_require__(158);
	
	var _ComponentsPsdCanvas2 = _interopRequireDefault(_ComponentsPsdCanvas);
	
	window.onload = function () {
	  _reactDom2['default'].render(_react2['default'].createElement(_ComponentsPsdCanvas2['default'], null), document.querySelector('#container'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PsdGroup = __webpack_require__(160);
	
	var _PsdGroup2 = _interopRequireDefault(_PsdGroup);
	
	var PsdCanvas = _react2['default'].createClass({
	  displayName: 'PsdCanvas',
	  ...
	  render: function render() {
	    return _react2['default'].createElement(
	      'div',
	      null,
	      _react2['default'].createElement(_PsdGroup2['default'], { data: this.state.data })
	    );
	  },
	  componentDidMount: function componentDidMount() {
	    var source = 'http://127.0.0.1:3000/api/get/psd?url=test.psd';
	    _jquery2['default'].get(source, (function (result) {
	      this.setState({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PsdLayer = __webpack_require__(161);
	
	var _PsdLayer2 = _interopRequireDefault(_PsdLayer);
	
	var _libUtil = __webpack_require__(162);
	
	var _libUtil2 = _interopRequireDefault(_libUtil);
	
	var PsdGroup = _react2['default'].createClass({
	  displayName: 'PsdGroup',
	    ...
	    return _react2['default'].createElement(
	      ...
	      children.map(function (child, key) {
	        if (child.type === 'group' && child.children && child.children.length > 0) {
	          return _react2['default'].createElement(
	            'div',
	            { key: 'group_' + key, style: groupDefaultStyles },
	            _react2['default'].createElement(
	              'div',
	              null,
	              child.name
	            ),
	            _react2['default'].createElement(PsdGroup, { data: JSON.stringify(child) })
	          );
	        } else if (child.type === 'layer') {
	          return _react2['default'].createElement(
	            'div',
	            { key: 'layer_' + key, style: groupDefaultStyles },
	            _react2['default'].createElement(_PsdLayer2['default'], { key: key, data: JSON.stringify(child) })
	          );
	        }
	      })
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PsdLayer = _react2['default'].createClass({
	  displayName: 'PsdLayer',
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement(
	      'div',
	      { style: layerCommonStyles },
	      (function () {
	        if (data.text) {
	          return _react2['default'].createElement(_Panel2['default'], { title: data.name, content: data.text });
	        }
	      })()
	    );
	  }
...
/***/ function(module, exports) {
	...
	var proto = {
	  importStyles: function importStyles(node) {
	    var string = {};
	  ...
	  formatFontText: function formatFontText(obj) {
	  ...
	  toString: function toString(obj, sp) {
	    var keys;
	    var kv;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Panel = _react2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    if (!title) return _react2['default'].createElement('div', null);
	    return this.getPanel(title, content);
	  },
	  getPanel: function getPanel(title, content) {
	    var wrapperStyles = {
	    ...
	    content.font = JSON.stringify(_libUtil2['default'].formatFontText(content.font));
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(_Row2['default'], { data: content.font })
	      )
	    );
	  }
	});
