	    ...
	    return _react2['default'].createElement(
	      ...
	      children.map(function (child, key) {
	        if (child.type === 'group' && child.children && child.children.length > 0) {
	          ...
	          return _react2['default'].createElement(_PsdLayer2['default'], { key: key, data: JSON.stringify(child) });
	        }
	      })
	    );
	  }
...
/***/ function(module, exports) {
	...
	var proto = {
	  ...
	  outFontText: function outFontText(obj) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Panel = _react2['default'].createClass({
	  ...
	  getPanel: function getPanel(title, content) {
	    ...
	    content.font = JSON.stringify(_libUtil2['default'].outFontText(content.font));
